...
| Cross-user data leakage | Critical multi-tenant risk; Phase 1 controls are runtime-validated for current tables. | Preserve RLS, composite tenant FKs, tenant-context propagation, and adversarial isolation tests for every new private entity. |
